...
extension UnifiedSpacing on num {
  ...
  EdgeInsets get mx => EdgeInsets.symmetric(horizontal: w); // Margin horizontal (x)
  ...
  EdgeInsets get px => EdgeInsets.symmetric(horizontal: w); // Padding horizontal (x)
  EdgeInsets get py => EdgeInsets.symmetric(vertical: h); // Padding vertical (y)
